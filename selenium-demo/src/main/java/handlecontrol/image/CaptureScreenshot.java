...
public class CaptureScreenshot {
	...
	public static void main(String[] args) throws IOException {
		...
		File srcProduct = featuredproducts.getScreenshotAs(OutputType.FILE);
		File trgProduct = new File(dirPath + "\\screenshots\\featureproducts.png");
		FileUtils.copyFile(srcProduct, trgProduct);

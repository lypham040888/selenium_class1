...
public class StaticTableDemo {
	...
	public static void main(String[] args) {
		 ...
		 * author=driver.findElement(By.xpath("//table[@name='BookTable']//tr["+r+
		 * "]/td[2]")).getText();
		 * 
		 * if(author.equals("Mukesh")) { String
		 * bookname=driver.findElement(By.xpath("//table[@name='BookTable']//tr["+r+
		 * "]/td[1]")).getText(); System.out.println(author+"    "+bookname); }
		 * 
		 * }
		 */
